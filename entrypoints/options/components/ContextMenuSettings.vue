...
const getMenuIcon = (id: string) => {
  const map: Record<string, string> = {
    ...
    wikipedia: '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12.062 13.91l4.032-10.749L12.059 8.23l-4.04-5.068 4.043 10.748zm8.681-10.749l-6.068 15.385-4.223-11.458 4.707-3.927h4.088c.883 0 1.496.066 1.496.066zm-17.486 0l5.962 15.385 4.316-11.458-4.706-3.927H3.257s-1.393-.066-2.28 0c0 0 .618-.066 1.496-.066h11.23c.883 0 1.501.066 1.501.066s-.618-.066-1.501-.066H9.379l-4.122 3.927z"/></svg>',
